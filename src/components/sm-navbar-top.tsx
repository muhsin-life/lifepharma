            ...
            <TransitionComp
                ...
                <div className="grid grid-flow-col  bg-life-2 text-white  text-xs px-2 py-1 md:hidden ">
                    <div className="flex justify-start">
                        ...
                        <div className="my-auto sm:text-sm  text-[8px] mx-2">{t.navbar.highest_rated_phar}</div>
                    </div>
                    <div className="text-end sm:text-sm  text-[8px]  my-auto font-bold">{t.navbar.download_now}</div>
                </div>
            </TransitionComp>
            : null
    )
